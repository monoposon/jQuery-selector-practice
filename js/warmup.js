window.Warmup = {
  ...
  initialize: function () {
    ...
    */
    showNamesForSelector("#under-isaiah-button", '[data-employment="full-time"] + ul span');

    /*
      Description: show the names of the people under Eulalia
      Outcome: Claude, Lowell
    */
    showNamesForSelector("#under-eulalia-button", '#vp + ul span');

    /*
      Description: values of all of the input fields of type text
      Outcome: Joe, Example
    */
    showValuesForSelector("#text-field-button", 'form [type="text"]');
